import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.f16e6129.js";const A=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"pages/Earnings/代码整洁之道/总结.md","filePath":"pages/Earnings/代码整洁之道/总结.md"}'),p={name:"pages/Earnings/代码整洁之道/总结.md"},o=l(`<h2 id="使用object-assign-设置默认对象" tabindex="-1">使用Object.assign 设置默认对象 <a class="header-anchor" href="#使用object-assign-设置默认对象" aria-label="Permalink to &quot;使用Object.assign 设置默认对象&quot;">​</a></h2><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">  </span><span style="color:#F97583;">const</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">menuconfig</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> {</span></span>
