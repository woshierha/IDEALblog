import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.464c1bfb.js";const D=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"pages/Earnings/格式/index.md","filePath":"pages/Earnings/格式/index.md"}'),p={name:"pages/Earnings/格式/index.md"},o=l(`<div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">//访问属性的时候用点</span></span>
